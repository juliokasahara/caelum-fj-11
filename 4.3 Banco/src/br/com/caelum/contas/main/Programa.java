...
public class Programa {
	public static void main(String[] args) {
		...
		System.out.println(
				anaGerente.getNome() + " Bonificação da classe objeto Gerente salario:" + anaGerente.getBonificacao());

		System.out.println(anaFuncionaria.getNome() + " funcionario salario:" + anaFuncionaria.getSalario());
		System.out.println(anaFuncionaria.getNome() + " Bonificação da classe objeto Funcionario salario:"
